...
│  │  │             │   │              │   │                       │ │ │
│  │  │ llama-3.1-  │   │ LangChain    │   │ llama-3.1-70b        │ │ │
...
| **LLM Provider** | Groq (llama-3.1-70b + 8b-instant) | Ultra-fast inference via LPU hardware |
...
LangGraph Node 3: generateUIData
  → Groq llama-3.1-70b generates structured JSON for the UI component
      │
      ▼
